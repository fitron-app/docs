...
│  │  ╭─╯        ╰──╮        │  │   6│╭──╯         ╰──╮        │  │
│  │╭─╯              ╰╮      │  │   0│                    │  │  │
│  │  月卡  季卡  次卡 体验卡 │  │   6  8 10 12 14 16 18 20 │  │
│  │  56%   18%  15%  11%    │  │     时段（小时）          │  │
│  └─────────────────────────┘  └──────────────────────────────┘  │
│                                                                 │
│  ┌─ 门店营收对比（多店模式可见）─────────────────────────────┐  │
...
| 优惠券使用总金额 | 已核销优惠券抵扣总额 |
| 优惠券核销率 | 已核销数 / 已发放数 |
| 券码带来的增量订单 | 使用优惠券的订单中，因券而转化的订单数 |
| ROI | 优惠券带来的增量收入 / 优惠让利金额 |
...
│                                                                 │
│  飞书应用状态：🟢 已连接                                        │
│  最后同步时间：2026-03-31 02:00:00                              │
│                                                                 │
│  ┌─ 同步任务列表 ──────────────────────────────────────────┐   │
│  │                                                         │   │
│  │  表格名称         │ 同步频率  │ 最后成功   │ 状态       │   │
│  │  ─────────────────┼──────────┼────────────┼────────     │   │
│  │  每日经营汇总     │ 每天凌晨  │ 02:00     │ 🟢 正常    │   │
│  │  订单明细         │ 每小时    │ 18:00     │ 🟢 正常    │   │
│  │  用户列表         │ 每天凌晨  │ 02:05     │ 🟢 正常    │   │
│  │  告警记录         │ 每小时    │ 18:00     │ 🟢 正常    │   │
│  │                                                         │   │
